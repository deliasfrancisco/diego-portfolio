...
export const OWNER = {
  ...
  linkedin:  'https://www.linkedin.com/in/deliasfrancisco/',
  email:     'diego.francisco.dev@gmail.com',
  emailSocial: 'diego.francisco.dev@hotmail.com',
  whatsapp:  '5518981485074',
...
export const EXPERIENCE = [
  {
    ...
    descPt:  'Contratado para gerenciar e refatorar um sistema legado de gerenciamento portuário originalmente desenvolvido pela Callidus Tecnologia. Modernizei o stack completo para .NET 10 + Angular 21. Projetei nova arquitetura com remoção de EmpresaId, soft-delete com IsDeleted e AuditLog em JSON. Implementei agendamento de tarefas com Hangfire e rastreamento de veículos em tempo real via SignalR.',
  ...
  },
  {
    ...
    descPt:  'Desenvolvi aplicações web empresariais para clientes dos setores de logística e finanças. SPAs Angular com APIs .NET Core, cache Redis e pipelines CI/CD via GitHub Actions. Apps mobile multiplataforma com Ionic 8 + Capacitor consumindo APIs REST existentes.',
  ...
  },
  {
    ...
    descPt:  'Desenvolvi e mantive aplicações integradas com ERP, pipelines de relatórios e sistemas ASP.NET com alto volume de dados. Construí uma sólida base em tuning de performance no SQL Server, stored procedures complexas e otimização de queries.',
...
export const PROJECTS = [
  {
    ...
    descPt:    'Reescrita completa do sistema de gerenciamento portuário. Stack legado Callidus → moderno .NET 10 + Angular 21 com pipeline de deploy no IIS e CI/CD com GitHub Actions.',
  ...
  },
  {
    ...
    descPt:    'Módulo de inspeção veicular multiplataforma com suporte offline. Ionic 8 + Capacitor + Angular consumindo WebAPI .NET Core.',
  ...
  },
  {
    ...
    descPt:    'PoC de microsserviços distribuídos do MBA com cache Redis, eventos em tempo real via SignalR, jobs assíncronos com Hangfire e deploy no Azure.',
  ...
  },
  {
    ...
    descPt:    'Workflow GitHub Actions reutilizável para projetos .NET + Angular. Etapas de build, test, publish e deploy no IIS com scripts PowerShell.',
